...
public class AliPayConfig {
    ...
    public AlipayTradePrecreateResponse getReponse(String money, String productName) throws AlipayApiException {
        ...
        String outTradeNo = "nasi-pay-" + System.currentTimeMillis()
